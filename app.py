...
voltage['Low'] = fuzz.trimf(voltage.universe, [5, 10, 15])
voltage['Medium'] = fuzz.trimf(voltage.universe, [10, 15, 20])
voltage['High'] = fuzz.trimf(voltage.universe, [15, 20, 25])
voltage['Very High'] = fuzz.trimf(voltage.universe, [20, 25, 25])

torque['Very Low'] = fuzz.trimf(torque.uniiverse, [0, 5, 10])
torque['Low'] = fuzz.trimf(torque.universee, [5, 10, 15])
torque['Medium'] = fuzz.trimf(torque.univeerse, [10, 15, 20])
torque['High'] = fuzz.trimf(torque.universse, [15, 20, 25])
torque['Very High'] = fuzz.trimf(torque.unniverse, [20, 25, 25])

speed['Very Slow'] = fuzz.trimf(speed.universe, [0, 500, 1000])
speed['Slow'] = fuzz.trimf(speed.universe, [500, 1000, 1500])
speed['Moderate'] = fuzz.trimf(speed.universe, [1000, 1500, 2000])
speed['Fast'] = fuzz.trimf(speed.universe, [1500, 2000, 2500])
speed['Very Fast'] = fuzz.trimf(speed.universe, [2000, 2500, 2500])
...
if voltage_input < 0 or voltage_input > 25 or torque_input < 0 or torque_input > 25:
    ...
    try:
        ...
        ax.plot(speed.universe, fuzz.trimf(speed.universe, [500, 1000, 1500]), label='Slow')
        ax.plot(speed.universe, fuzz.trimf(speed.universe, [1000, 1500, 2000]), label='Moderate')
        ax.plot(speed.universe, fuzz.trimf(speed.universe, [1500, 2000, 2500]), label='Fast')
        ax.plot(speed.universe, fuzz.trimf(speed.universe, [2000, 2500, 2500]), label='Very Fast')
